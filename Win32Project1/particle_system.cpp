...
{   
    ...
    m_updateTechnique.SetLauncherLifetime(300.0f);
    m_updateTechnique.SetShellLifetime(200000.0f);
    ...
    m_billboardTechnique.SetBillboardSize(0.07f);
    
    m_pTexture = new Texture(GL_TEXTURE_2D, "../Content/snow.png");
...
void ParticleSystem::UpdateParticles(int DeltaTimeMillis)
{
    ...
    if (m_isFirst) {
        glDrawArrays(GL_POINTS, 0, X_AMOUNT*Z_AMOUNT);
